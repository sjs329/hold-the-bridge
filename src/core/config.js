  ...
  const LEVEL_DEFS = [
    {
      level: 1,
      enemyQuota: 125,
      enemy: { spawnInterval: 1.15, maxActive: 24, burstChance: 0.75, speedMin: 24.0, speedMax: 32.0, healthBonus: 2, eliteChance: 0.30, attackMin: 1.05, attackMax: 1.55, giantChance: 0.00, smallChance: 0.45 },
    ...
    },
    {
      level: 2,
      enemyQuota: 160,
      enemy: { spawnInterval: 1.0, maxActive: 27, burstChance: 0.82, speedMin: 26.0, speedMax: 35.0, healthBonus: 2, eliteChance: 0.36, attackMin: 0.92, attackMax: 1.42, giantChance: 0.05, smallChance: 0.38 },
    ...
    },
    {
      level: 3,
      enemyQuota: 200,
      enemy: { spawnInterval: 0.9, maxActive: 30, burstChance: 0.88, speedMin: 28.0, speedMax: 38.0, healthBonus: 3, eliteChance: 0.42, attackMin: 0.82, attackMax: 1.30, giantChance: 0.12, smallChance: 0.30 },
    ...
    },
    {
      level: 4,
      enemyQuota: 245,
      enemy: { spawnInterval: 0.8, maxActive: 34, burstChance: 0.94, speedMin: 30.0, speedMax: 41.0, healthBonus: 3, eliteChance: 0.48, attackMin: 0.74, attackMax: 1.18, giantChance: 0.20, smallChance: 0.22 },
    ...
    },
    {
      level: 5,
      enemyQuota: 300,
      enemy: { spawnInterval: 0.74, maxActive: 38, burstChance: 0.96, speedMin: 32.0, speedMax: 44.0, healthBonus: 4, eliteChance: 0.54, attackMin: 0.68, attackMax: 1.08, giantChance: 0.27, smallChance: 0.16 },
    ...
    },
    {
      level: 6,
      enemyQuota: 360,
      enemy: { spawnInterval: 0.68, maxActive: 42, burstChance: 0.97, speedMin: 34.0, speedMax: 47.0, healthBonus: 4, eliteChance: 0.60, attackMin: 0.62, attackMax: 1.00, giantChance: 0.34, smallChance: 0.11 },
